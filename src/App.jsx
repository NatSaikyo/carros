    ...
    <main className='min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center'>
      <section className='lg:flex'>
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <p className='font-lexend mb-7 text-offwhite'>Escolha um sedan pelo seu preço acessível e excelente economia de combustivel. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
          <a className='font-lexend px-10 py-3 bg-offwhitebg lbock w-fit rounded-3xl text-orange' href="https://www.webmotors.com.br/sedans" target='_blank'>Ver mais</a>
        </div>
        ...
        <div className='bg-green p-12'>
          ...
          <a className='font-lexend px-10 py-3 bg-offwhitebg block w-fit rounded-3xl text-green' href="https://www.webmotors.com.br/suvs" target='_blank'>Ver mais</a>
        </div>
        ...
        <div className='bg-dark-green p-12 rounded-b-lg'>
          ...
          <a className='font-lexend px-10 py-3 bg-offwhitebg block w-fit rounded-3xl text-dark-green' href="https://www.webmotors.com.br/carros-de-luxo" target='_blank'>Ver mais</a>
        </div>
      </section>
    </main>
  )
