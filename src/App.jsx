    ...
    <main>
      <section>
        <div className="bg-orange">
          ...
          <p className='font-lexend'>Escolha um sedan pelo seu preço acessível e excelente economia de combustivel. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
