    ...
    <main className='min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center'>
      <section className='lg:flex max-w-[920px]'>
        <div className="bg-orange p-12 max-lg:rounded-t-lg lg:rounded-l-lg">
          ...
          <p className='font-lexend mb-7 text-offwhite lg:mb-20'>Escolha um sedan pelo seu preço acessível e excelente economia de combustivel. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
          <a className='font-lexend px-10 py-3 bg-offwhitebg block w-fit rounded-3xl text-orange border-2 border-offwhitebg hover:bg-orange hover:text-offwhitebg' href="https://www.webmotors.com.br/sedans" target='_blank'>Ver mais</a>
        </div>
        ...
        <div className='bg-green p-12'>
          ...
          <a className='font-lexend px-10 py-3 bg-offwhitebg block w-fit rounded-3xl text-green border-2 border-offwhitebg hover:bg-green hover:text-offwhitebg' href="https://www.webmotors.com.br/suvs" target='_blank'>Ver mais</a>
        </div>
        ...
        <div className='bg-dark-green p-12 max-lg:rounded-b-lg lg:rounded-r-lg'>
          ...
          <a className='font-lexend px-10 py-3 bg-offwhitebg block w-fit rounded-3xl text-dark-green border-2 border-offwhitebg hover:bg-dark-green hover:text-offwhitebg' href="https://www.webmotors.com.br/carros-de-luxo" target='_blank'>Ver mais</a>
        </div>
      </section>
    </main>
  )
