    ...
    <main className='min-h-svh bg-offwhitebg py-20 px-6'>
      <section>
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <p className='font-lexend mb-7'>Escolha um sedan pelo seu preço acessível e excelente economia de combustivel. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
